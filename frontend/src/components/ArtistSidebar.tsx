          ...
          >
            ...
            <div className="flex flex-col h-full pt-5 pb-4 overflow-y-auto">
              ...
              <div className="flex-shrink-0 flex items-center px-6 mb-8">
                <h1 className="text-2xl font-bold text-text-primary-light">刺青師後台</h1>
              </div>
                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={() => setSidebarOpen(false)}
                      className={cn(
                        "flex items-center px-4 py-3.5 text-base font-medium rounded-r-md transition-all duration-150 border-l-4",
                        isActive
                          ? "bg-blue-100 text-blue-900 border-blue-600"
                          : "text-text-secondary-light hover:bg-gray-100 border-transparent"
                      )}
                    >
      ...
      <div className="hidden lg:block lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:w-64">
        <div className="flex flex-col h-full bg-white shadow-lg">
          ...
          <div className="flex items-center justify-center h-16 px-4 border-b border-gray-200">
            <h1 className="text-xl font-bold text-text-primary-light">刺青師後台</h1>
          </div>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    isActive
                      ...
                      : "text-text-secondary-light hover:bg-gray-100 hover:text-text-primary-light"
                  )}
                >
